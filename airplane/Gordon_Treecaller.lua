function event_spawn(e)
	...
	e.self:Say("I, Gordon Treecaller, bid you good day. ");
end

function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Hello " .. e.other:GetName() .. ", I can only hope that my disturbance was necessary. Ahh, you seem to be decently adept with a blade. Would you like to be tested in the element of thunder, the blade, or the art of ranged attack? Or have you already been tested and are looking for things to trade?");
	elseif(e.message:findi("thunder")) then		--ranger test of the element of thunder
	...
	elseif(e.message:findi("ranged")) then 	--ranger test of the art of ranged attack
