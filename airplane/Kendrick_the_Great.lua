function event_spawn(e)
	...
	e.self:Say("I am Kendrick the great.");
end

function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Welcome, " .. e.other:GetName() .. ". I am apprentice Kendrick. Do you wish to test your abilities?");
	...
	elseif(e.message:findi("trickery")) then 	--rogue test of trickery
		e.self:Say("Trickery, ahh how Fizzlethorpe blesses us! Adventure and return a mottled spiroc feather, a cracked leather belt, and a sphinxian circlet to complete the test of trickery and earn Renard's Belt of Quickness.");
	end
end
