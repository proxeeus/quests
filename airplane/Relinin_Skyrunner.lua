function event_spawn(e)
	...
	e.self:Say("I, Relinin Skyrunner, bid you good day. ");
end

function event_say(e)
	if(e.message:findi("hail")) then
		e.self:Say("Greetings " .. e.other:GetName() .. ". I can only assume my reasons for being summoned is that you wish to take the tests. Would you like to be tested in the body, in defense, in the element of earth or would you like to trade?");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 20934, item2 = 20850, item3 = 20849})) then 	--ranger test of body using auburn tessera, griffon talon, ysgaril root
		e.other:SummonItem(14567); 	--griffon talon
