...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 10990})) then -- Yulcabis's axe
		e.self:Say("Excellent work. Now that we no longer have to bother with Yulcabis, I suppose we can discuss your progression as a member of the Dark Reflection. Take this Dull Dark Reflection Axe and sharpen it in a forge with a sharpening stone. It may take several attempts if you are unfamiliar with the process. Once the blade has been sharpened take the axe to Clockwork Smith XIII with an Ebon Drake scale and he will put the finishing touches on your new weapon..");
		--e.other:SummonItem(11077);	-- plague warrior battle axe
		e.other:SummonItem(10995)
		e.other:AddEXP(1000);
		e.other:Ding();
