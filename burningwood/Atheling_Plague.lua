...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 12764}) ) then
		e.self:Emote("tosses the skull over the edge of the tower. 'Excellent. You show signs of a true Iksar slayer. Too, bad I have already given the skull of the Sister of Scale to another. Perhaps you would like to meet him before he departs. Say hello, Doval.'");
		eq.unique_spawn(87156,0,0,e.self:GetX() + 5,e.self:GetY(),e.self:GetZ());
