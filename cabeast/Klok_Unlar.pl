sub EVENT_SAY { 
	if($text=~/hail/i){
		quest::emote("wipes flour from his hands and turns to greet you. 'Welcome! Please look over my many treats. Do not think of the coin you shall spend. Heavy coin buys the finest and sweetest of treats. Feel free to ask me about any of the rare pies you see as I can tell you exactly how I make them.'");
	}
	if($text=~/bixie berry pie/i){
...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 12676 =>1 )) {
    ...
    quest::spawn2(106137,0,0,120,563,4, -1); 
  }
}
