...
sub EVENT_SAY {
	...
	if ($text=~/new revenant/i) {
		quest::emote("ceases in his chanting and gazes into your mind. 'Yes. You are. You shall do as I command. Take this. It is incomplete and must be ready for the emperor within the half season. You must find the [Four Missing Gems]. When you have them, then you will have to Quest for the [Grand Forge of Dalnir]. Within it's fire, all shall combine. Return the Sceptre to me with your Revenant Skullcap. Go.'"); 
...
sub EVENT_ITEM {
	if(plugin::check_handin(\%itemcount, 18207 => 1)){ #Guild Summons
		...
		quest::say("I await both the sceptre and your revenant skullcap.");
