...
quest::say("Greetings. $name. perhaps you've come to purchase some of my rare supplies? I have a special blend of eleven herbs and spices......oh wait.....I'm sold out of that......anyway. what can I do for you?"); 
   ...
   if($text=~/vagnar/i)
   {
      quest::say("Vagnar? I don't recall.....Unless Vagnar was that shaman supposedly on some quest to save our entire race from total destruction..someone always on one of those. He bought some charms to ward-off [Dragon kin]. He's most likely in the belly of some beast now.");
   }
   if($text=~/dragon kin/i )
   {
