...
sub EVENT_ITEM {
    if (plugin::check_handin(\%itemcount, 1046 => 1, 30162 => 1)) {
        ...
        $corbin2 = quest::spawn2(116574, 234, 0, $x, $y, $z, $h);
...
sub EVENT_WAYPOINT_DEPART {
    if ($wp == 39) {
		...
		quest::say("Almost there now, just a bit further...");
	}
}
...
sub EVENT_SIGNAL {
    quest::stoptimer("depop");
    quest::spawn2(116574, 235, 0, $x, $y, $z, $h);
    quest::depop();
}
...
#END of FILE Zone:eastwastes  ID:116145 ID:116574 -- Corbin_Blackwell
