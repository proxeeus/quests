...
function event_trade(e)
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 14330})) then
		e.self:Say("Very interesting... I've seen this work before. Yes, yes! It's the work of Arantir Karondor! Give this back to the person you got it from. Maybe he will have a clue to Arantir's location.");
