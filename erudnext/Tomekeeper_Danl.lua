function event_say(e)
		...
		elseif(e.message:findi("power of the immortals")) then
		...
		elseif(e.message:findi("disciple of Kaiaren")) then 
		...
		elseif(e.message:findi("vortix")) then
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 18195})) then
		...
		e.other:Ding();
	elseif(item_lib.check_turn_in(e.trade, {item1 = 48132})) then
		...
		e.self:Say("Well I suppose I do owe you the information you had come here seeking. Unfortunately, I do not know much more than what is in this book already. The other references I have found do speak of another [disciple of Kaiaren].");
	end
