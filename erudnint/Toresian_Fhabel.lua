...
function event_say(e)
	...
	elseif(e.message:findi("study enchantment")) then
		...
		if(eq.get_entity_list():IsMobSpawnedByNpcTypeID(23093) == false or eq.get_entity_list():IsMobSpawnedByNpcTypeID(23001) ==  false) then
			eq.unique_spawn(eq.ChooseRandom(23093,23001),0,0,575,683,-12.13,156);
		end
