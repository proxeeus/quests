...
{ 
	...
	{
		quest::say("I command you to seek out this Ambassor D'Vinn and rip his heart from his lifeless body. Next, find the supreme caster of the orcs and, finally, find the spot where supplies are dropped by the Teir`Dal for the orcs. There you should find the supply crate. Return all three items and you shall wield the falchion.");
	}
}
...
{ 
  ...
  elsif(plugin::check_handin(\%itemcount, 12330 => 1, 12329 => 1, 13227 => 1))
	{ # A Large Locked Crate, Blue Orc Head, Black Heart
