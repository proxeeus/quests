...
sub EVENT_SAY {
 ...
 if($text=~/who are the very few?/i) {
 ...
 if($text=~/What wisps of consciousness?/i) {
 ...
 if($text=~/Who or what is the Heyokah?/i) {
 ...
 if($text=~/I will walk the path of the Heyokah/i) {
