...
local qglobals = eq.get_qglobals(e.other)
	...
	elseif(qglobals["druid_epic"] == "3" and e.message:findi("Soulbinder Grunson sent me")) then
		e.self:Say("You mean Geadin. Caskin's eyes lose their focus for a moment as he appears to be reminiscing. Geadin was a good friend of mine but I haven't seen him in ten years, not since his [problems] with the Soulbinders.");
