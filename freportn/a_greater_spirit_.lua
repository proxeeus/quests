...
function event_say(e)
	if(e.message:findi("hail")) then -- Part of Shaman Epic 1.0
		e.self:Say("It is good to see you. We're glad you trusted in our brother and did what was asked regardless of Bondl's intentions. This fills us with joy, as the [true spirits] work in ways most people would not understand and [trust] is the first lesson of the [Heyokah].?");
