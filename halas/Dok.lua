function event_say(e)
	...
	elseif(e.message:findi("clan mcmannus")) then
		e.self:Say("Methinks it is Einhorst McMannus. Clan McMannus were instructed by the Council to live far away from Halas.  They now live in the Western Plains of Karana and supply Halas with food and materials from the warmer regions.");
...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 12222})) then
		e.self:Say("Great work!! Now I can make more candles! Here ye are, me friend. I call this the Everburn Candle. It has a wee bit o' magic in it. I hope ye like it.");
