function event_say(e)
	if(e.message:findi("hail")) then
  	...
  	elseif(e.message:findi("triple strength rum")) then
		e.self:Say("Aye. A better rum I never had. Warms the stomach and brings a tear to the eye. Our leader, Captain Nalot, used ta make it. Can't find any ingredients in this ice clad hell, though.");
