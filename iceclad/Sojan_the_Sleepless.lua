...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 25104})) then -- toolset Delivery (kael)
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 30037})) then -- Wolf Fur Earcovers
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 30038, item2 = 30057})) then -- Fine Gold Chain and Golden Broken Key
