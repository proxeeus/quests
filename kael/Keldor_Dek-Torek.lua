function event_combat(e)
	if(e.joined) then
		e.self:Say("You have made your last mistake.");
	end
end
...
function event_waypoint_arrive(e)
	...
	elseif(e.wp == 13) then
		...
		eq.zone_emote(0,"King Tormax says 'So it will be then.  The halls of the great temple of Rallos Zek shall not be walked by any other than the true children of Zek, the giants.  We will have to work harder to recruit outlanders into our service as well.  If we are to wipe the dragons from the face of Velious we will need hundreds of powerful mercenaries to fight alongside us.'");
	elseif(e.wp == 14) then
