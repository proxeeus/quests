...
function event_say(e)
	...
	elseif (e.message:findi("giants")) and (e.other:GetFaction(e.self) <= 5) then	
		e.self:Say("There are several encampments in the [" .. eq.say_link("eastern wastes") .. "] that barter for supplies with us monthly.  The [great divide] also has a small outpost of Kromrif who strive to beat the Coldain back into their city of Thurgadin and of course the outposts in the wakening lands.  Our last batch of deliveries did not reach their intended targets.  The runners have not been heard from since they were dispatched either.");
