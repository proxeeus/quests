...
function event_trade(e)
	...
	if(e.other:GetFaction(e.self) < 5 and item_lib.check_turn_in(e.trade, {item1 = 25128,item2 = 25129,item3 = 25127})) then --  Bloody claws of Draazak, Jerigozia, and Veredenia
		...
		e.other:Faction(448,75); -- Faction: Kromzek
		e.other:Faction(419,18); -- Faction: Kromrif
		e.other:Faction(429,18); -- Faction: King Tormax
		e.other:Faction(430,-37); -- Faction: Claws of Veeshan
...
function event_combat(e)
	if(e.joined) then
		e.self:Say("How dare you take up arms against me!");
	end
end