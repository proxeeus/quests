...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 30245}, 0) or item_lib.check_turn_in(e.trade, {item1 = 30246}, 0)) then
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 30270}, 0)) then
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 30273}, 0)) then
	...
	elseif(item_lib.check_turn_in(e.trade, {item1 = 30273,item2 = 30249}, 0)) then
		e.self:Say("Yes.  Exactly as I thought.  Hrm.  I'd keep this but you've done much work.  You may be one of the filthy outlanders but you can keep it.  You can save your thanks.");
