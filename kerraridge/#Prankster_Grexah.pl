...
sub EVENT_WAYPOINT {                     # when he gets to kobold pen
  if($wp==19){
    ...
    quest::spawn2(74541,29,0,143.5,332.2,7.0,375.8);
    quest::spawn2(74541,30,0,6.7,61.5,5.0,224.4);
    quest::spawn2(74541,31,0,391.7,646.1,1.0,176.8);
    quest::spawn2(74541,32,0,372.9,928.9,9.8,415.2);
