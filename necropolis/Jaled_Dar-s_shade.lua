...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 9296}, 0) or
		item_lib.check_turn_in(e.trade, {item1 = 27255}, 0) or
		item_lib.check_turn_in(e.trade, {item1 = 27256}, 0) or
		item_lib.check_turn_in(e.trade, {item1 = 27258}, 0) or
		item_lib.check_turn_in(e.trade, {item1 = 27259}, 0) or
		item_lib.check_turn_in(e.trade, {item1 = 27266}, 0)) then
