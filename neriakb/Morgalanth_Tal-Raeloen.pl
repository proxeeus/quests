...
sub EVENT_ITEM {
	if (plugin::check_handin(\%itemcount, 22642 => 1, 22643 => 1, 22644 => 1)) {
		...
		quest::say("I don't need this $name. Take this back.");
