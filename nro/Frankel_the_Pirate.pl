...
sub EVENT_SAY {
 if($text=~/hail/i){ ## I found this in the net
  quest::say("Hey there $name, You look like a $race in search of opertunity. If I'm right and I know I am, then where better than the land of ice, rocks and ice? Oh, with giants and dragons from sea to shining sea. That peaked your [interest], eh?");
   }
...
sub EVENT_COMBAT {
  ...
  if(($combat_state == 1) &&($random_result<=17)){
    ...
    quest::say("Argggh I don't believe I never expected to win ye award for the most underconed NPC in the game - I thank ye for this award and if any of ye be getting in me way you'll be seeing the me fist stuffed down ye throught faster than you can you know waht hit ye!");}
}
