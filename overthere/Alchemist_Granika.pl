...
sub EVENT_ITEM {
 if (plugin::check_handin(\%itemcount, 3892 => 1)) {
  ...
  quest::spawn2(93304,0,0,1955,2825,-49,380); #Spawn the golem and three guards
  quest::spawn2(93305,0,0,1955,2794,-49,380); # NPC: #an_undead_marine
  quest::spawn2(93305,0,0,1954,2855,-49,380); # NPC: #an_undead_marine
  quest::spawn2(93305,0,0,1915,2825,-49,380); # NPC: #an_undead_marine
