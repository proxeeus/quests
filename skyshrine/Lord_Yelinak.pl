...
sub EVENT_ITEM {
  ...
  if ($faction <= 3) { # require kindly faction
    ...
    if(plugin::check_handin(\%itemcount, 30516 => 1)){
      ...
      quest::say("I lost the scales that made these boots in a battle with Tormax's minions. The casters of the shrine gathered these fallen scales up and fashioned a very powerful enchantment into these boots.");
