...
function event_trade(e)
    ...
    if (item_lib.check_turn_in(e.trade, {item1 = 29062, item2 = 29062, item3 = 29062, item4 = 29062})) then --Giant Helms
        helms = 4;
    elseif (item_lib.check_turn_in(e.trade, {item1 = 29062, item2 = 29062, item3 = 29062})) then --Giant Helms
        helms = 3;
    elseif (item_lib.check_turn_in(e.trade, {item1 = 29062, item2 = 29062})) then --Giant Helms
        helms = 2;
    elseif (item_lib.check_turn_in(e.trade, {item1 = 29062})) then --Giant Helms
        helms = 1;
    end
    ...
    if (helms > 0) then
        ...
        e.other:Faction(430, 15); --CoV
        e.other:Faction(436, 3); --Yelinak
        e.other:Faction(448, -7); --Kromzek
        helms = helms - 1;
        until helms == 0
    end

    if (item_lib.check_turn_in(e.trade, {item1 = 29624, item2 = 29624, item3 = 29624, item4 =29624})) then --Merc Assignments
        mercAssigments = 4;
    elseif (item_lib.check_turn_in(e.trade, {item1 = 29624, item2 = 29624, item3 = 29624})) then --Merc Assignments
        mercAssigments = 3;
    elseif (item_lib.check_turn_in(e.trade, {item1 = 29624, item2 = 29624})) then --Merc Assignments
        mercAssigments = 2;
    elseif (item_lib.check_turn_in(e.trade, {item1 = 29624})) then --Merc Assignments
        mercAssigments = 1;
    end
    ...
    if(item_lib.check_turn_in(e.trade, {item1 = 29124}) or item_lib.check_turn_in(e.trade, {item1 = 29125})) then	--Storm giant or Frost giant toes
