...
sub EVENT_ITEM{
   ...
   if(plugin::check_handin(\%itemcount, 12405 => 4)){ 
    ...
    quest::say("We still have much work to do!");
    quest::faction(95,10); # +Exiled Frogloks
    quest::faction(106,10); # +Frogloks of Guk
    quest::faction(107,10); # +Frogloks of Krup
    quest::faction(108,10); # +Frogloks of Kunark
    quest::faction(109,10); # +Frogloks of Sebilis
    quest::ding(); quest::exp(5);
    quest::givecash(1,3,6,0);
  ...
  if(plugin::check_handin(\%itemcount, 11951 => 2)){ 
    ...
    quest::faction(109,10); # +Frogloks of Sebilis
     quest::ding(); quest::exp(5);
    quest::givecash(8,8,15,0); #FrogChain
    if($random_result<12){
