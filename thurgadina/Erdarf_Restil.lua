...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 30269}, 0)) then -- Sceptre of the Coldain Ancients
		...
		eq.depop_with_timer();
	elseif(item_lib.check_turn_in(e.trade, {item1 = 30271}, 0)) then -- Bottle of Karsin Acid
