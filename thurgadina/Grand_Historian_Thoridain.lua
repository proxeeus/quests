...
function event_trade(e)
	...
	if(item_lib.check_turn_in(e.trade, {item1 = 1428,item2 = 1418})) then
		...
		e.other:Faction(406,5); -- coldain
		e.other:Faction(405,1); -- dain
		e.other:Faction(448,-1); -- kzek
		e.other:Faction(419,-2); -- krif
