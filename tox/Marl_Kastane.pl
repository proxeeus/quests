...
sub EVENT_ITEM {
  if (plugin::check_handin(\%itemcount, 14376 => 1)) {
    quest::emote("reads the note, eyes widening in panic. He raises his eyes to you and says, 'This is grave news, friend. If [this prophecy] is allowed to be fulfilled, our strength will vanish into obscurity. Goodness and purity will spread like a plague across the land and the servants of Hate will be powerless to stop it!'");
    quest::faction(404, 7);
	quest::exp(5000);
	quest::ding();
  }
  if (plugin::check_handin(\%itemcount, 14381 => 1)) {
  ...
  if (plugin::check_handin(\%itemcount, 14379 => 1)) {
