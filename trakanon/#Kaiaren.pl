...
sub EVENT_ITEM {
  if(plugin::check_handin(\%itemcount, 1683 => 1)) { #Celestial Fists (Book)
  ...
  elsif(plugin::check_handin(\%itemcount, 1684 => 1)) { #Charred Scale
  ...
  elsif(plugin::check_handin(\%itemcount, 1688 => 1, 1689 => 1)) { #Demon Fangs and Book of Celestial Fists
